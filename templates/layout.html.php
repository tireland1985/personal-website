    ...
    <header>
        <div class="navbar-fixed">
            <ul id="dropdown1" class="dropdown-content">
                <li><a href="/cv.php">Overview</a></li>
                <li><a href="/cv.php#education">Education</a></li>
                <li><a href="/cv.php#pro-exp">Professional Experience</a></li>
                <li><a href="/cv.php#other-exp">Other Experience</a></li>
                <li><a href="/cv.php#skills">Skills</a></li>
                <li><a href="/download.php?download_file=Tim-Ireland-CV.pdf">Download</a></li>
                <li><a href="/university-projects.php">University Projects</a></li>
            </ul>
            <nav>
